...
public class Ejecutor001 {
    public static void main(String[] args) {
        MenuNinos menuNinos1 = new MenuNinos("Hamburguesa", 8.5, 10.0, 2.0, 3.0);
        MenuNinos menuNinos2 = new MenuNinos("Pizza", 9.0, 12.0, 1.5, 2.5);
        MenuEconomico menuEconomico = new MenuEconomico("Pollo asado", 7.0, 9.0, 20.0);
        MenuDia menuDia = new MenuDia("Sopa del día", 5.0, 7.0, 1.5, 1.0);
        MenuCarta menuCarta = new MenuCarta("Filete de res", 15.0, 18.0, 3.0, 2.0, 10.0);
